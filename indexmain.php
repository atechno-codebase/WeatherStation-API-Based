...
background-image: linear-gradient(
  145deg,
  hsl(303deg 72% 53%) 0%,
  hsl(237deg 100% 74%) 10%,
  hsl(200deg 100% 50%) 20%,
  hsl(194deg 100% 50%) 30%,
  hsl(183deg 100% 45%) 40%,
  hsl(165deg 76% 54%) 50%,
  hsl(184deg 100% 46%) 60%,
  hsl(192deg 100% 50%) 70%,
  hsl(209deg 100% 69%) 80%,
  hsl(267deg 86% 78%) 90%,
  hsl(325deg 79% 71%) 100%
);
...
.buttons{
	width:100%;
	height:50vh;
	background:url("./images/slopes.webp");
...
<a href="index.php">Table Records date</a> 
</button>
<button  class = "record3">
<a href="index3.php">Table Records hours</a> 
</button>
<button  class = "record3">
<a href="ContactUS/index.php">ContactUS</a> 
</button>
<button  class = "record3">
<a href="crud/index.php">Login</a> 
</button>
</div>
<div class ="Map">
